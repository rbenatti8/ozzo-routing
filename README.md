...
[![GoDoc](https://godoc.org/github.com/rbenatti8/ozzo-routing?status.png)](http://godoc.org/github.com/rbenatti8/ozzo-routing)
...
[![Go Report](https://goreportcard.com/badge/github.com/rbenatti8/ozzo-routing)](https://goreportcard.com/report/github.com/rbenatti8/ozzo-routing)

**This is a fork of the original ozzo-routing package, updated to suit specific needs. The main changes include updating the Go version and upgrading dependencies to address security vulnerabilities.**
...
```
go get github.com/rbenatti8/ozzo-routing/v2
```
...
--------------------------------|--------------------------------------------
[access.Logger](https://godoc.org/github.com/rbenatti8/ozzo-routing/access) | records an entry for every incoming request
[auth.Basic](https://godoc.org/github.com/rbenatti8/ozzo-routing/auth) | provides authentication via HTTP Basic
[auth.Bearer](https://godoc.org/github.com/rbenatti8/ozzo-routing/auth) | provides authentication via HTTP Bearer
[auth.Query](https://godoc.org/github.com/rbenatti8/ozzo-routing/auth) | provides authentication via token-based query parameter
[auth.JWT](https://godoc.org/github.com/rbenatti8/ozzo-routing/auth) | provides JWT-based authentication
[content.TypeNegotiator](https://godoc.org/github.com/rbenatti8/ozzo-routing/content) | supports content negotiation by response types
[content.LanguageNegotiator](https://godoc.org/github.com/rbenatti8/ozzo-routing/content) | supports content negotiation by accepted languages
[cors.Handler](https://godoc.org/github.com/rbenatti8/ozzo-routing/cors) | implements the CORS (Cross Origin Resource Sharing) specification from the W3C
[fault.Recovery](https://godoc.org/github.com/rbenatti8/ozzo-routing/fault) | recovers from panics and handles errors returned by handlers
[fault.PanicHandler](https://godoc.org/github.com/rbenatti8/ozzo-routing/fault) | recovers from panics happened in the handlers
[fault.ErrorHandler](https://godoc.org/github.com/rbenatti8/ozzo-routing/fault) | handles errors returned by handlers by writing them in an appropriate format to the response
[file.Server](https://godoc.org/github.com/rbenatti8/ozzo-routing/file) | serves the files under the specified folder as response content
[file.Content](https://godoc.org/github.com/rbenatti8/ozzo-routing/file) | serves the content of the specified file as the response
[slash.Remover](https://godoc.org/github.com/rbenatti8/ozzo-routing/slash) | removes the trailing slashes from the request URL and redirects to the proper URL
